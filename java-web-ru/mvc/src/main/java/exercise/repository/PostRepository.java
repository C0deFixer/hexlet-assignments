...
public class PostRepository {
    ...
    public static void save(Post post) {
        ...
        Optional<Post> findedPost = find(post.getId());
        if (findedPost.isPresent()) {
            Post editedPost = findedPost.get();
            editedPost.setName(post.getName());
    ...
    public static boolean nameIsFreeOfUse(String name, Long id) {
        Optional<Post> findedPost= findByName(name);
        return findedPost.isEmpty() || findedPost.get().getId() == id;
    }
}
